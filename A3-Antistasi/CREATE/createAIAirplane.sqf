...
if (_patrol) then
	...
	while {(spawner getVariable _markerX != 2) and (_countX < 4)} do
		{
		_arraygroups = if (_lado == Occupants) then {groupsNATOsmall} else {groupsCSATsmall};
