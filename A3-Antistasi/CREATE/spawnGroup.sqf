...
//private ["_grupo","_countX","_countRanks","_LeaderX","_unitsX","_index","_positionX","_sideX","_typesX","_override","_canBypass"];
private ["_grupo","_countX","_countRanks","_LeaderX","_unitsX","_index"];
