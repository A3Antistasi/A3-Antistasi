...
player addAction ["flyX",{player setVelocityModelSpace [((velocityModelSpace player) select 0) + 0,((velocityModelSpace player) select 1) + 1000,((velocityModelSpace player) select 2) + 10]}];
