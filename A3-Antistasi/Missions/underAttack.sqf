private ["_marcador","_nameDest","_nombreEny"];
...
[_lado,_marcador,[format ["%2 is attacking us in %1. Help the defense if you can",_nameDest,_nombreEny],format ["%1 Contact Rep",_nombreEny],_marcador],getMarkerPos _marcador,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
