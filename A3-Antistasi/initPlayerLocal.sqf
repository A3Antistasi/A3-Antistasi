...
if (isMultiplayer) then {flagX addAction ["Faction Garage", {nul = [GARAGE_FACTION] spawn A3A_fnc_garage},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull]) and (side (group _this) == teamPlayer)"]};
