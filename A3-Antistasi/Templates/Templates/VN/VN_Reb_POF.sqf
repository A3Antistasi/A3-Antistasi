...
_loadoutData set ["binoculars", ["vn_m19_binocs_grey"]];
...
_loadoutData set ["items_explosivesExpert_extras", ["vn_b_item_toolkit", "ACE_Clacker", "ACE_DefusalKit"]];
_loadoutData set ["items_engineer_extras", ["vn_b_item_toolkit"]];
