...
initialRebelEquipment append (faction_rebel getVariable "uniforms");
initialRebelEquipment append (faction_civ getVariable "uniforms");
initialRebelEquipment append (faction_civ getVariable "headgear");
