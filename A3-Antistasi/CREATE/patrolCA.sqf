...
_base = if ((_posOrigen distance _posDestination < distanceForLandAttack) and ([_posDestination,_posOrigen] call A3A_fnc_isTheSameIsland) and (_threatEvalLand <= 15)) then {_airportX} else {""};
