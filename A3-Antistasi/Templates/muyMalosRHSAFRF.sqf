...
vehCSATTrucks = ["rhs_kamaz5350_vdv","rhs_kamaz5350_open_vdv","RHS_Ural_Open_VDV_01","rhs_gaz66_vdv","RHS_Ural_VDV_01"];
vehCSATAmmoTruck = "rhs_gaz66_ammo_vmf";
vehCSATLight = vehCSATLightArmed + vehCSATLightUnarmed;
vehCSATAPC = ["rhs_bmp2d_vdv","rhs_bmp1p_vdv","rhs_btr80a_vdv","rhs_bmd2m","rhsbmp3mera_msv"];
vehCSATTank = ["rhs_sprut_vdv","rhs_t80ue1","rhs_t80u","rhs_t80um","rhs_t90a_tv","rhs_t90_tv"];
...
vehCSATPlaneAA = ["RHS_T50_vvs_051","RHS_T50_vvs_blueonblue"];
...
municionCSAT append ["rhs_mag_nspn_yellow","rhs_mag_nspn_red","rhs_mag_nspn_green","rhs_mag_nspd"];
humo = humo + ["rhs_mag_nspd","rhs_mag_rdg2_white","rhs_mag_rdg2_black","rhs_mag_zarya2","rhs_mag_rgo","rhs_mag_rgn","rhs_mag_plamyam","rhs_mag_fakels","rhs_mag_fakel"];
