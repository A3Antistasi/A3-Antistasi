...
_x addEventHandler ["Killed",
	...
	if ({alive _x} count units _grupo == 0) then
		...
		if (((lados getVariable [_origen,sideUnknown] == malos) and (lados getVariable [_destino,sideUnknown] == malos)) or ((lados getVariable [_origen,sideUnknown] == ) and (lados getVariable [_destino,sideUnknown] == ))) then
			{
