...
_sfLoadoutData set ["uniforms", ["rhs_uniform_6sh122_gloves_v2"]];			//this line determines uniforms for special forces -- Example: ["U_B_CombatUniform_mcam", "U_B_CombatUniform_mcam_tshirt"] -- Array, can contain multiple assets
...
_militiaLoadoutData set ["helmets", ["rhs_fieldcap_m88", "rhs_fieldcap_m88_back"]];
