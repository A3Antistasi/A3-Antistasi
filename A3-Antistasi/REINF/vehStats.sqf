...
private ["_grupo","_veh","_textX","_unitsX"];
...
_textX = format ["%1 Status\n\nAlive members: %2\nAble to combat: %3\nCurrent task: %4\nCombat Mode:%5\n",groupID _grupo,{alive _x} count _unitsX,{[_x] call A3A_fnc_canFight} count _unitsX,_grupo getVariable ["taskX","Patrol"],behaviour (leader _grupo)];
