...
private ["_tipo","_lado","_markerX","_modo","_garrison","_subTipo"];
...
_exit = false;
//diag_log format ["Antistasi: Error en garrisonUpdate al enviar mal dataX: %1,%2,%3,%4",_tipo,_lado,_markerX,_modo];
