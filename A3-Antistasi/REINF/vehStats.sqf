...
private ["_group","_veh","_texto","_unitsX"];
...
_texto = format ["%1 Status\n\nAlive members: %2\nAble to combat: %3\nCurrent task: %4\nCombat Mode:%5\n",groupID _group,{alive _x} count _unitsX,{[_x] call A3A_fnc_canFight} count _unitsX,_group getVariable ["tarea","Patrol"],behaviour (leader _group)];
