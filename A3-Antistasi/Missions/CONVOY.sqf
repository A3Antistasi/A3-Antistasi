...
_vehicle=[_pos,_dir,_typeVehX, _group] call bis_fnc_spawnvehicle;
...
[_base,_posDestination,_group] call WPCreate;
_wp0 = _group addWaypoint [_posDestination, count waypoints _group];
_wp0 setWaypointType "MOVE";
