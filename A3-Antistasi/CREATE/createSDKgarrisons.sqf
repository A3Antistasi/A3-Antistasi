...
private ["_markerX","_vehiclesX","_groups","_soldiers","_positionX","_pos","_size","_veh","_staticsX","_garrison","_tam","_countX","_group","_groupMortar","_typeX","_unit"];
...
for "_i" from 0 to (count _groups) - 1 do
	...
	if (_i == 0) then
		{
		_nul = [leader _group, _markerX, "SAFE","SPAWNED","RANDOMUP","NOVEH2","NOFOLLOW"] execVM "scripts\UPSMON.sqf";
		}
	else
		{
