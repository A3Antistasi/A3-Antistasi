...
if (((_lado == malos) and (not(_marcador in mrkNATO))) or ((_lado == muyMalos) and (not(_marcador in mrkCSAT)))) exitWith {hint "You need to be close to an Airbase, Seaport or Outpost of your side in order to request a bike"};
