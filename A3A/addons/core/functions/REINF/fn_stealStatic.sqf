...
if (A3A_hasRHS and ((typeOf _staticX == FactionGet(reb,"staticAT")) or (typeOf _staticX == FactionGet(reb,"staticAA")))) exitWith {["Steal Static", "This weapon cannot be dissassembled."] call A3A_fnc_customHint;};
