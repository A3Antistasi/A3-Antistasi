private ["_positionX","_size","_buildings","_grupo","_tipoUnit","_lado","_building","_tipoB","_frontierX","_tipoVeh","_veh","_vehiclesX","_soldiers","_pos","_ang","_markerX","_unit","_return"];
