...
_nombreC = "None";
private _hr = floor(server getVariable "hr");
private _hrCap = floor(server getVariable ["hrCap", 0]);

if (!isMultiplayer) then
	{
	_texto = format ["<t size='0.60'>" + "HR: %1/%11 | %9 Money: %2 € | Airstrikes: %5 | %7 Aggr: %3 | %8 Aggr: %4 | War Level: %6 | Undercover Mode: %10", 
		_hr, server getVariable "resourcesFIA",floor prestigeNATO,floor prestigeCSAT,floor bombRuns,tierWar,nameMalos,nameMuyMalos,nameBuenos,
