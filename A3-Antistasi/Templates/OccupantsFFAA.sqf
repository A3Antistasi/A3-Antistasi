...
groupsFIAMid = [["ffaa_brilat_jefe_peloton","ffaa_brilat_tirador_ameli","ffaa_brilat_soldado","ffaa_brilat_alcotan"],["ffaa_brilat_jefe_peloton","ffaa_brilat_tirador_ameli","ffaa_brilat_soldado","ffaa_brilat_c90"]];//["IRG_InfAssault","IRG_InfTeam","IRG_InfTeam_AT"];///
