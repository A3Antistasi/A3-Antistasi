...
[_lado,_marcador,[format ["Contact with %2 reported at %1.",_nombreDest,_nombreEny],format ["%1 Contact Report",_nombreEny],_marcador],getMarkerPos _marcador,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
