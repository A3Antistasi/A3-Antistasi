/*  =====================================================================================================
 ...
 =====================================================================================================
	Par?meters: [_artillery,(_rounds,_area,_cadence,_mincadence)] execvm QPATHTOFOLDER(Scripts\UPSMON\MON_artillery_add.sqf);
 ...
 =====================================================================================================
	...
	2. Exec module in int of static weapon
		...
		nul=[this] execVM QPATHTOFOLDER(Scripts\UPSMON\MON_artillery_add.sqf);
